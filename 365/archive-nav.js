(() => {
    ...
    const pages = [
        ...
        { key: 'rginfv1-arc', file: 'rginfv1-arc.html', accent: '#4a9eff', position: 'DAYS 18–29', aria: 'RGInfV1 chat into memory arc' },
        ...
        { key: 'chat-corpus-arc', file: 'chat-corpus-arc.html', accent: '#69a9ff', position: 'DAYS 31–37', aria: 'Chat Exports and Corpus archive arc' },
        { day: 33, file: 'corpus-about.html', accent: '#69a9ff' },
        { key: 'local-agent-learning', file: 'local-agent-learning.html', accent: '#cbd5e1', position: 'DAYS 40–45', aria: 'Learning agents locally arc' },
        { day: 44, file: 'karpathy-agent-studies.html', accent: '#fb923c' },
        ...
        { key: 'americans-sonnet45', file: 'americans-sonnet45-arc.html', accent: '#d98c6a', position: 'DAYS 53–58+', aria: 'Americans and Sonnet 4.5 ongoing arc' },
        ...
        { key: 'high-signal-building', file: 'high-signal-building.html', accent: '#4ade80', position: 'DAYS 86–93', aria: 'High-signal building arc' },
        { day: 89, file: 'music-room-about.html', accent: '#cd804c' },
        { day: 93, file: 'rg-claude-about.html', accent: '#4ade80' },
        { key: 'nerv-pair', file: 'nerv-pair.html', accent: '#00ff41', position: 'DAYS 95–96', aria: 'NERV Terminal and System Monitor pair' },
        { day: 95, file: 'day9.html', accent: '#00ff41' },
        { day: 96, file: 'day10.html', accent: '#ff6b00' },
        { key: 'local-inference-path', file: 'local-inference-path.html', accent: '#78e7d1', position: 'DAYS 104–121', aria: 'Local inference path systems arc' },
        ...
        { day: 220, href: '/365/world-showcase/', accent: '#ff9b35' }
    ];
